...
module.exports = {
	...
	output: {
		...
		chunkFilename: 'static/js/[name].[chunkhash:8].chunk-rexhang.js',
	...
	resolve: {
		...
		alias: {
			...
			// Support src source dist new add by rexhang && webstorm ide config tooltips
	...
	plugins: [
		...
		new MiniCssExtractPlugin({
			...
			chunkFilename: 'static/css/[name].[contenthash:8].chunk-rexhang.css',
		}),
