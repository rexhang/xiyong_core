...
class Prescribe extends React.Component {
  ...
  static templateInfo = [{ ...common_template }, { ...vip }];
  ...
  actions = {
    handleTemplateSelected: (selId) => {
      ...
      if (handleData) {
        ...
        this.FormWrapCommonInputs &&
          this.FormWrapCommonInputs.props.form.resetFields();
        const {
          templateId,
          templateName,
          templateAliasName,
  ...
  dataCenter = {
            ...
            this.setState(
              ...
              () => {
                if (
                  ...
                  // let cf_info_list = _.cloneDeep(this.state.cf_info_list);
                  let cf_info_list = window.Array.from([
                    ...this.state.cf_info_list,
                  ]);
    ...
    getdiseaserecordlistPages: (
      page = 1,
      id = this.editSickBookId,
      is_getPageOne = false,
      date = ''
    ) => {
      let queryParams = {
        ...
        if (res.data.code === 200) {
          ...
          let setState = {
            formQueryDatas: {
              ...
              diagnosis_id:
                D.diagnosis_ids === '' ? [] : D.diagnosis_ids.split(','),
              tcm_id: D.tcm_ids === '' ? [] : D.tcm_ids.split(','),
              treatment_id:
                D.treatment_ids === '' ? [] : D.treatment_ids.split(','),
              western_diagnosis_id:
                D.western_diagnosis_ids === ''
                  ? []
                  : D.western_diagnosis_ids.split(','),
              advise: D.advise,
          ...
          if (is_getPageOne) {
            ...
            this.setState({
              formQueryDatas: {
                ...
                update_time: D.update_time,
                files,
                current_date: res.data.data.date
                  ? res.data.data.date
                  : undefined,
                dates: [],
              },
    ...
    getCfInfo: (id) => {
      $http
        .get(API.prescriptionListInfoGet, {
          id,
        })
        .then((res) => {
          if (res.data.code === 200) {
            ...
            let setObj = {
              ...
              drug_group_list_id:
                datas.drug_group_id === '0' ||
                datas.drug_group_id === 0 ||
                datas.drug_group_id === ''
                  ? undefined
                  : datas.drug_group_id,
              hide_cf_list:
                datas.drug_group_type === '5' || datas.drug_group_type === '2',
              thumb: datas.thumb,
              poster: datas.poster,
            ...
            if (datas.type === '1') {
              ...
              setObj.activeKey2 = '2';
              setObj.ll_list_id =
                datas.liliao_id !== '0' && datas.liliao_id !== ''
                  ? datas.liliao_id
                  : undefined;
          ...
          $http
            ...
            .then((res) => {
              if (res.data.code === 200) {
                if (is_inside) {
                  // 获取病历内页列表
                  this.dataCenter.getdiseaserecordlistPages(
                    this.state.sickBook_current_page
                  );
                } else {
                  // 获取病历簿列表
                  this.dataCenter.getdiseaserecordlist(
                    this.state.blList_current_page,
    ...
    saveCfContent: (postdata, cb, type = 'create') => {
      if (type === 'create') {
        ...
        $http
          .post(API.prescriptionCreate, postdata)
          .then((res) => {
            this.setState({
              saveCfContent_loading: false,
            });
            if (res.data.code === 200) {
              ...
              Modal.confirm({
                ...
                onOk: () => {
                  $http
                    .post(API.prescriptionCreate, {
                      ...postdata,
                      ignore_drug_warning: '1',
                    })
                    .then((res) => {
                      if (res.data.code === 200) {
                        cb(res.data.data.code);
        ...
        $http
          .post(API.prescriptionSave, postdata)
          .then((res) => {
            this.setState({
              saveCfContent_loading: false,
            });
    ...
    savediseaserecordlist: () => {
      ...
      const {
        ...
        western_diagnosis_id,
        drug_reaction,
      } = this.state.formQueryDatas; // 必填字段
      ...
      let postObject = {
        ...
        western_diagnosis_ids:
          western_diagnosis_id.length > 0 ? western_diagnosis_id.join(',') : '',
      ...
      $http
        .post(API.createDiseaseRecord, postObject)
        .then((res) => {
          if (res.data.code === 200) {
            // 获取病历簿列表
            this.dataCenter.getdiseaserecordlist(
    ...
    createLL: (postdata, cb, type = 'create') => {
      if (type === 'create') {
        ...
        $http
          .post(API.acupointcreate, postdata)
          .then((res) => {
            if (res.data.code === 200) {
              this.setState({
                saveLL_loading: false,
      ...
      $http
        ...
        .then((res) => {
          if (res.data.code === 200) {
            ...
            // 刷新进度
            this.dataCenter.getcfList(
              1,
              this.state.formQueryDatas.disease_record_id
            );
          }
        })
        .finally(() => {
  ...
  saveLL = () => {
    ...
    let postdata = {
      prescription_id: 0,
      acupoint_ids:
        this.state.xuewei_list_id !== undefined &&
        this.state.xuewei_list_id.length > 0
          ? this.state.xuewei_list_id.join(',')
          : '',
                  ...
                  <List
                    ...
                    renderItem={(item) => (
                      <List.Item className="rex-item-hover">
                        <List.Item.Meta title={<span>无匹配结果...</span>} />
                      </List.Item>
                    )}
                  />
                ) : (
  ...
  handleMeTypeChange = (e) => {
    ...
    if (
      this.state.drugData2_id !== undefined &&
      this.state.drugData2_id !== null
    ) {
  ...
  handleDrugGroupChange = (v) => {
    ...
    if (v === undefined || v === null) {
      ...
      const money = this.state.drug_group_list.find((val) => val.id === v)
        .money;
      this.setState({
    ...
    if (this.state.me_type === '0') {
      ...
      const drugs = this.state.drug_group_list
        .find((val) => val.id === v)
        .drugs.map((val) => {
          return {
            ...val,
  ...
  addCfRows = () => {
    ...
    // 判断重复id = 重复药材检测
    const resCheck = this.state.cf_info_list.findIndex(
      (val) => val.drug_id * 1 === this.state.associate_id * 1
    );
    if (resCheck !== -1) {
    ...
    this.setState(
      {
        cf_info_list: [
          ...
          ...[
            {
              drug_id: this.state.associate_id,
              weight: this.state.associate_weight,
              price: this.state.associate_price,
              datas: this.state.associate_datas,
              empty: false,
            },
          ],
        ],
  ...
  saveCfContent = () => {
    ...
    if (me_type === '4') {
      ...
      if (
        this.state.waiyongNums.split(',').length !==
        this.state.waiyongListID.length
      ) {
    ...
    if (me_type === '2' || me_type === 2) {
      ...
      drugs =
        '[' +
        [window.JSON.stringify({ id: drugData2_id, weight: '1' })].join(',') +
        ']';
    }
    let postdata = {
      patient_id: this.state.currentUserInfo.id,
  ...
  openCamera = () => {
    ...
    const initCamera = () => {
      //  判断浏览器是否支持
      let isSupport = (navigator.getUserMedia =
      ...
      if (isSupport) {
        const constraintsOpts = {
          audio: false,
          video: { width: 310, height: 310 },
        };
        //  调用摄像头  成功后获取视频流：mediaStream
        navigator.mediaDevices
          .getUserMedia(constraintsOpts)
          .then((mediaStream) => {
  ...
  takePhoto = () => {
    ...
    canvas.toBlob((blob) => {
      ...
      const cameraFile = new File([u8arr], fileName.toString() + '.jpg', {
        type: mime,
      });
      this.setState({
        cameraFile,
  ...
  uploadPhoto = () => {
    ...
    reqwest({
      ...
      headers: {
        'Http-Authorization':
          LocalStorage.getObject('xy_userinfo').token || 'token not found',
      },
      success: (res) => {
        this.setState({
          cameraFileUploading: false,
        ...
        if (res.code === 200) {
          ...
          message.success(res.data.file_name + '文件上传成功', 0.8, () => {
            console.log(this.state.fileList);
  ...
  render() {
    ...
    let current_cf_update_time = null,
      last_cf_update_time = null;
    ...
    youhui_money =
      state.coupon_data_id * 1 === 100
        ? 0
        : window.Math.abs(
            state.cf_nums * 1 * (unit_money * 1) - real_money * 1
          ).toFixed(2);

    let waiyongPrice = 0,
      youhuiPrice = 0;
    if (
      this.state.waiyongListID.length > 0 &&
      this.state.waiyongList.length > 0
    ) {
      this.state.waiyongListID.forEach((priceObj, priceIndex) => {
        if (
          ...
          const numPrice = this.state.waiyongNums.split(',')[priceIndex]
            ? window.parseInt(this.state.waiyongNums.split(',')[priceIndex])
            : 0;

          waiyongPrice +=
            this.state.waiyongList.find(
              (vo) => vo.id.toString() === priceObj.toString()
            ).price *
            1 *
            numPrice;
        }
      ...
      <div className="Prescribe" id="Prescribe">
        ...
        <div className="content">
          <div className="filter-box">
            <Input.Search
              ...
              onChange={(asval) =>
                this.handleUserSearchChangeFor(asval.target.value)
              }
              onSearch={(val) => this.handleUserSearchFor(val)}
            />
            {this.renderItems().SEARCH(
              state.shouldShowSearchBox,
              state.user_list,
              state.searchLoading
            )}
          </div>
            ...
            <div className="main-box">
              ...
              <div className="infomations">
                <div className="userinfo">
                  ...
                  >
                    ...
                    <Descriptions.Item label="身份证号码">
                      {id_num ? id_num : '该患者未更新资料'}
                    </Descriptions.Item>
                    <Descriptions.Item label="就诊卡余额">
                      {balance}
                    </Descriptions.Item>
                    <Descriptions.Item label="头像信息">
                      <div
                        onClick={() => {
                          this.setState({
                            viewUserAvatar: true,
                        ...
                        style={{
                          ...
                          height: 120,
                          padding: '4px',
                          cursor: `url(${require('./assets/pointer_mouse.cur')}), pointer`,
                        }}
                      >
                        <img src={avatar_pic} height={'100%'} alt="" />
                      </div>
                    </Descriptions.Item>
                    <Descriptions.Item label="特征备注信息">
                      <Input.TextArea
                        placeholder="请输入特征备注信息"
                        value={state.feature}
                        autoSize={{
                          minRows: 6,
                          maxRows: 6,
                      ...
                      />
                      <Button onClick={() => this.saveFeature()}>
                        保存备注
                      </Button>
                    </Descriptions.Item>
                  </Descriptions>
                ...
                <div className="sick-list">
                  <div className="name">
                    患者病历簿
                    {state.blList_total_page >= 1
                      ? `(共${state.blList_total_page}条)`
                      : ''}
                  </div>
                  <Button icon={'plus'} onClick={() => this.createSickBook()}>
                    新增病历簿
                  </Button>
                  <div className="rex-cf">
                          ...
                          <Col key={v.id} span={8}>
                            <Card
                              ...
                              actions={[
                                <Button
                                  type="link"
                                  onClick={() => this.addSickBookInfo(v.id)}
                                >
                                  新增一页
                                </Button>,
                                <Button
                                  type="link"
                                  onClick={() => this.getSickBookInfo(v.id)}
                                >
                                  查看/编辑
                                </Button>,
                                <Button
                                  type="link"
                                  onClick={() =>
                                    this.dataCenter.deletediseaserecordlist(
                                      v.id
                                    )
                                  }
                                >
                    ...
                    <div className="paginationLeft">
                      <Pagination
                        ...
                        pageSize={Prescribe.blPageSize}
                        current={state.blList_current_page}
                        total={state.blList_total_page}
                        onChange={(page) => {
                          this.dataCenter.getdiseaserecordlist(
                            page,
        ...
        >
          <div className="createSickBook">
            <div className="form-ctrls rex-cf">
              ...
              <div className="item rex-fl">
                ...
                <Input
                  ...
                  style={{ width: 200 }}
                  value={`${
                    LocalStorage.getObject('xy_userinfo').department_name
                  }/${LocalStorage.getObject('xy_userinfo').username}(${
                    LocalStorage.getObject('xy_userinfo').job
                  })`}
                />
              </div>
            </div>
            ...
            <div className="form-ctrls rex-cf">
              <div
                className="item rex-fl"
                style={{
                  display: 'flex',
                  alignItems: 'center',
                }}
              >
                <span className="rex-fl name">
                  当前系统日期: {moment().format(Prescribe.dateformat)}
                </span>
              </div>
            </div>
              ...
              <React.Fragment>
                ...
                <div className="form-ctrls rex-cf">
                  <div className="item rex-fl" style={{ display: 'flex' }}>
                    <span className="rex-fl name">
                      上次就诊日期: {this.state.formQueryDatas.current_date}
                    </span>
                  </div>
                </div>
              </React.Fragment>
              ...
              >
                <TabPane tab="就诊信息" key="1" className="tb-1">
                    ...
                    <div>
                      <div className="form-ctrls">
                        <div className="label-box rex-cf align-center">
                          <span
                            className="label-name rex-fl w154"
                            style={{
                              textAlign: 'left',
                              width: 118,
                            }}
                          ...
                          <div className="label-forms rex-fl">
                            ...
                            >
                              {state.formQueryDatas.dates.map((v, i) => {
                                ...
                                return (
                                  <Option key={i} value={v} label={hunpinCode}>
                                    {v}
                                  </Option>
                                );
                              })}
                  ...
                  <div className="tempArea">
                    <Opt
                      ...
                      options={Prescribe.templateInfo}
                      onChange={this.actions.handleTemplateSelected}
                    />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <Button
                      icon={'rocket'}
                      onClick={() => {
                        ...
                        this.FormWrapCommonInputs &&
                          this.FormWrapCommonInputs.actions.submit();
                      }}
                    >
                      Lunch Button
                    </Button>
                  ...
                  <div className="DivFieldset1 render-template">
                    ...
                    <div className="DivFieldset1_content">
                      <div className="rex-fctns">
                        <FormWrapCommonInputs
                          style={{ width: 410 }}
                          templatedata={state.loadedTemplateInfo}
                          onRef={(FormWrapCommonInputs) =>
                            (this.FormWrapCommonInputs = FormWrapCommonInputs)
                          }
                        />
                      </div>
                    </div>
                      ...
                      <div className="rex-fctns">
                        <div className="form-ctrls">
                          <div className="label-box rex-cf">
                            <span className="label-name rex-fl w154">
                              患者主诉:{' '}
                            </span>
                            <div className="label-forms rex-fl">
                              <Input.TextArea
                                ...
                                value={state.formQueryDatas.patient_desc}
                                onChange={(v) =>
                                  this.handleForm(
                                    'patient_desc',
                                    v.target.value
                          ...
                          <div className="label-box rex-cf">
                            ...
                            <div className="label-forms rex-fl">
                              <Input.TextArea
                                ...
                                value={state.formQueryDatas.disease_history}
                                onChange={(v) =>
                                  this.handleForm(
                                    'disease_history',
                                    v.target.value
                          ...
                          <div className="label-box rex-cf">
                            ...
                            <div className="label-forms rex-fl">
                              <Input.TextArea
                                ...
                                value={state.formQueryDatas.disease_past}
                                onChange={(v) =>
                                  this.handleForm(
                                    'disease_past',
                                    v.target.value
                          ...
                          <div className="label-box rex-cf">
                            ...
                            <div className="label-forms rex-fl">
                              <Input.TextArea
                                ...
                                value={state.formQueryDatas.disease_family}
                                onChange={(v) =>
                                  this.handleForm(
                                    'disease_family',
                                    v.target.value
                          ...
                          <div className="label-box rex-cf">
                            ...
                            <div className="label-forms rex-fl">
                              <Input.TextArea
                                ...
                                value={state.formQueryDatas.inspection_result}
                                onChange={(v) =>
                                  this.handleForm(
                                    'inspection_result',
                                    v.target.value
                          ...
                          <div className="label-box rex-cf align-center">
                            ...
                            <div className="label-forms rex-fl">
                              <Select
                                ...
                                onChange={(v) =>
                                  this.handleForm('diagnosis_id', v)
                                }
                              >
                            ...
                            <Spin
                              spinning={state.addOpt2}
                              tip={'数据提交中...'}
                            >
                              <Input
                                value={state.addOpt_val2}
                                onChange={(e) =>
                                  this.setState({
                                    addOpt_val2: e.target.value,
                                  })
                                }
                                onPressEnter={(e) => {
                                  this.dataCenter.createOpts(e.target.value, 2);
                                }}
                                placeholder="新增中医诊断选项"
                                style={{
                                  width: 140,
                                }}
                              />
                        ...
                        <div className="form-ctrls">
                          <div className="label-box rex-cf align-center">
                            ...
                            <Placeholder width={10} />
                            <Spin
                              spinning={state.addOpt3}
                              tip={'数据提交中...'}
                            >
                              <Input
                                value={state.addOpt_val3}
                                onChange={(e) =>
                                  this.setState({
                                    addOpt_val3: e.target.value,
                                  })
                                }
                                onPressEnter={(e) => {
                                  this.dataCenter.createOpts(e.target.value, 3);
                                }}
                                placeholder="新增中医证型选项"
                                style={{
                                  width: 140,
                                }}
                              />
                          ...
                          <div className="label-box rex-cf align-center">
                            ...
                            <div className="label-forms rex-fl">
                              <Select
                                ...
                                onChange={(v) =>
                                  this.handleForm('treatment_id', v)
                                }
                              >
                            ...
                            <Placeholder width={10} />
                            <Spin
                              spinning={state.addOpt1}
                              tip={'数据提交中...'}
                            >
                              <Input
                                value={state.addOpt_val1}
                                onChange={(e) =>
                                  this.setState({
                                    addOpt_val1: e.target.value,
                                  })
                                }
                                onPressEnter={(e) => {
                                  this.dataCenter.createOpts(e.target.value, 1);
                                }}
                                placeholder="新增治法治则选项"
                                style={{
                                  width: 140,
                                }}
                              />
                          ...
                          <div className="label-box rex-cf align-center">
                            ...
                            <div className="label-forms rex-fl">
                              <Select
                                ...
                                value={
                                  state.formQueryDatas.western_diagnosis_id
                                }
                                onChange={(v) =>
                                  this.handleForm('western_diagnosis_id', v)
                                }
                              >
                            ...
                            <Placeholder width={10} />
                            <Spin
                              spinning={state.addOpt4}
                              tip={'数据提交中...'}
                            >
                              <Input
                                value={state.addOpt_val4}
                                onChange={(e) =>
                                  this.setState({
                                    addOpt_val4: e.target.value,
                                  })
                                }
                                onPressEnter={(e) => {
                                  this.dataCenter.createOpts(e.target.value, 4);
                                }}
                                placeholder="新增西医诊断选项"
                                style={{
                                  width: 140,
                                }}
                              />
                          ...
                          <div className="label-box rex-cf">
                            ...
                            <div className="label-forms rex-fl">
                              <Input.TextArea
                                ...
                                value={state.formQueryDatas.advise}
                                onChange={(v) =>
                                  this.handleForm('advise', v.target.value)
                                }
                                placeholder="请输入患者医嘱信息"
                                autoSize={{
                                  minRows: 2,
                                  maxRows: 6,
                                }}
                        ...
                        {/*新建病历簿的时候也没药后反应*/}
                        {/*新增一页的时候需要药后反应*/}
                        {state.sickBook_current_page ===
                          state.sickBook_total_page ||
                        state.sickBook_total_page === 0 ? null : (
                          <React.Fragment>
                            <Placeholder height={15} />
                            <div className="form-ctrls">
                              <div className="label-box rex-cf">
                                ...
                                <div className="label-forms rex-fl">
                                  <Input.TextArea
                                    ...
                                    value={state.formQueryDatas.drug_reaction}
                                    onChange={(v) =>
                                      this.handleForm(
                                        'drug_reaction',
                                        v.target.value
                          ...
                          <div className="label-box rex-cf">
                            ...
                            >
                              <Upload
                                ...
                                headers={{
                                  'Http-Authorization':
                                    LocalStorage.getObject('xy_userinfo')
                              ...
                              >
                                <div>
                                  <Spin
                                    spinning={state.cameraFileUploading}
                                    tip={'上传中...'}
                                  >
                                    <div
                                      className="c-center"
                        ...
                        <div className="form-ctrls">
                          <div className="label-box rex-cf">
                            ...
                            <div className="label-forms rex-fl">
                              ...
                              >
                                {state.fileList_videos.length >= 5 ? null : (
                                  <Button icon="plus">上传视频</Button>
                                )}
                              </Upload>
                            </div>
                          </div>
                  ...
                  <Button
                    icon="save"
                    onClick={() => this.dataCenter.savediseaserecordlist()}
                  >
                    保存
                  </Button>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  {/*保留一页不能删除: 保留最新的一页*/}
                  {state.sickBook_total_page > 1 &&
                  state.sickBook_current_page > 1 ? (
                    <Button
                      icon="delete"
                      type="danger"
                      onClick={() =>
                  ...
                  <div className="sick-book-paging">
                    <Pagination
                      hideOnSinglePage={true}
                      pageSize={1}
                      current={state.sickBook_current_page}
                      total={state.sickBook_total_page}
                      onChange={(page) => {
                ...
                {state.formQueryDatas.disease_record_id ? (
                  <TabPane tab="处方信息" key="2" className="tb-2">
                    <div name="w-800">
                      <Button icon="plus" onClick={() => this.createCF()}>
                        添加处方
                      </Button>
                      {/*筛选器*/}
                      <div>
                      ...
                      {state.cfList.length > 0 ? (
                        ...
                        >
                          <List
                            header={
                              <div className="ant-descriptions-title">{`本页已开处方(共${state.cfList_total_page}条)`}</div>
                            }
                            itemLayout="horizontal"
                            ...
                            renderItem={(item, _index) => {
                              ...
                              const ll_progress = `(理疗进度: ${
                                item.done_nums
                              }/${item.nums}) 理疗穴位: ${
                                item.acupoints.length > 0
                                  ? item.acupoints.join('、')
                                  : '无'
                              } 理疗名称: ${item.liliao_name}`;
                              return (
                                <List.Item
                                  actions={[
                                    <Input
                                      onPressEnter={(e) =>
                                        this.dataCenter.PhysiotherapyRecord(
                                          e.target.value,
                                          item
                                        )
                                      }
                                      className={
                                        item.type === '1' ? '' : 'rex-hide'
                                      }
                                      placeholder="进行一次理疗,填写操作医师名"
                                      style={{
                                        width: 220,
                                      }}
                                    />,
                                    ...
                                    <Button
                                      ...
                                      onClick={() => this.copyCF(item, _index)}
                                    >
                                      拷贝此处方
                                    </Button>,
                                  ]}
                      ...
                      <div className="choice-content rex-cf">
                        <div className="rex-fl">
                          <div className="cf-list-unit">
                            ...
                            <Radio.Group
                              onChange={(e) => this.handleMeTypeChange(e)}
                              value={state.me_type}
                            >
                          ...
                          <div
                            className="DivFieldset1"
                            style={{
                              display: `${
                                state.hide_cf_list ? 'none' : 'block'
                              }`,
                            }}
                          >
                            <div className="DivFieldset1_title">
                              中药材成分表
                            </div>
                            <div
                              className="DivFieldset1_content"
                              style={{
                                width: 530,
                              }}
                            >
                              <div className="rex-fctns">
                                <div
                                  className="cf-tools rex-scroll-bar"
                                  id="cf-ctrlbox"
                                >
                                  {/*固定的一行*/}
                                  <div
                                    className="cf-rows rex-cf"
                                    style={{
                                      marginBottom: 10,
                                    }}
                                  >
                                    ...
                                    <Select
                                      ...
                                      onChange={(val) => {
                                        ...
                                        let _price = state.drug_list.find(
                                          (_v) => _v.id === val
                                        ).price;
                                        _price = (_price * 1) / 1000;
                                        let _associate_weight = state.drug_list.find(
                                          (_v) => _v.id === val
                                        ).auto_weight;
                                        let name = state.drug_list.find(
                                          (_v) => _v.id === val
                                        ).name;
                                        // console.log(_price);
                                    ...
                                    >
                                      {state.drug_list.map((v, _sortindex) => {
                                        return (
                                          <Option key={_sortindex} value={v.id}>
                                            {v.name}
                                          </Option>
                                        );
                                      })}
                                      ...
                                      >
                                        ...
                                        <Select
                                          ...
                                          onChange={(val) => {
                                            ...
                                            const _price = state.drug_list.find(
                                              (_v) => _v.id === val
                                            ).price;
                                            cf_info_list[i].drug_id = val; // drug_id
                                            cf_info_list[i].price =
                                              (_price * 1) / 1000; // price
                                            this.setState({
                                              cf_info_list,
                                            });
                                        ...
                                        <Input
                                          ...
                                          onKeyUp={(e) => {
                                            ...
                                            if (
                                              ...
                                              document
                                                .getElementById('cf-ctrlbox')
                                                .getElementsByClassName(
                                                  'cf-rows'
                                                )
                                                [i + 2].getElementsByClassName(
                                                  'weight-focus'
                                                )[0]
                                        ...
                                        <Button
                                          size="small"
                                          className="remove-cf-rows rex-fl"
                                          type="link"
                                          onClick={() => this.removeCfRows(i)}
                                        >
                                          移除
                                        </Button>
                                      </div>
                            ...
                            <React.Fragment>
                              <div className="cf-list-unit">
                                ...
                                >
                                  {state.drinkStyle.map((v) => {
                                    // 拼 音 码 -> GetJP || 拼音全码 -> GetQP || 混 拼 码 -> GetHP
                                    const hunpinCode = window.Pinyin.GetJP(
                                      v.name
                                    );
                                    return (
                                      <Option
                              ...
                              <div className="cf-list-unit">
                                ...
                                <Input
                                  ...
                                  value={state.cf_remark}
                                  onChange={(e) =>
                                    this.setState({
                                      cf_remark: e.target.value,
                                    })
                                  }
                                  placeholder="输入处方备注信息"
                                />
                              </div>
                              <Placeholder height={15} />
                              <div className="cf-list-unit">
                              ...
                              {state.drugData2_id !== undefined &&
                              state.drugData2_id !== null ? (
                                <React.Fragment>
                                  <Placeholder height={15} />
                                  <div className="cf-list-unit">
                            ...
                            <React.Fragment>
                              <div className="cf-list-unit">
                                ...
                                <Input.TextArea
                                  ...
                                  value={state.zigouTEXT}
                                  onChange={(e) =>
                                    this.setState({
                                      zigouTEXT: e.target.value,
                                    })
                                  }
                                  placeholder="输入自购处方清单内容，如: 阿莫西林(3盒)，奥美拉唑(2盒)，莫沙必利(1盒)"
                                  autoSize={{
                                    minRows: 3,
                                    maxRows: 6,
                                  }}
                            ...
                            <React.Fragment>
                              ...
                              <div className="cf-list-unit">
                                ...
                                <Input
                                  ...
                                  value={state.waiyongNums}
                                  onChange={(e) =>
                                    this.setState({
                                      waiyongNums: e.target.value,
                                    })
                                  }
                                  placeholder="输入外用药个数(阿拉伯数字), 英文逗号分开, 如: 1, 2, 3"
                                />
                              </div>
                              <Placeholder height={15} />
                              <div className="cf-list-unit">
                          ...
                          <div className="rex-cf">
                            <Button
                              ...
                              loading={this.state.saveCfContent_loading}
                              onClick={() => this.saveCfContent()}
                            >
                              {state.status === '20' || state.status === 20
                                ? '已支付'
                                : state.status === '30' || state.status === 30
                                ? '已退款'
                                : '保存/修改'}
                            </Button>
                            {this.cfEditId ? (
                              ...
                              <div className="form-ctrls">
                                <div className="label-box rex-cf align-center">
                                  ...
                                  <div className="label-forms rex-fl">
                                    ...
                                    >
                                      {state.formQueryDatas.dates.map(
                                        (v, i) => {
                                          // 拼 音 码 -> GetJP || 拼音全码 -> GetQP || 混 拼 码 -> GetHP
                                          const hunpinCode = window.Pinyin.GetJP(
                                            v
                                  ...
                                  <div className="label-box rex-cf">
                                    ...
                                    <div className="label-forms rex-fl">
                                      <Input.TextArea
                                        ...
                                        value={
                                          state.formQueryDatas.patient_desc
                                        }
                                        onChange={(v) =>
                                          this.handleForm(
                                            'patient_desc',
                                  ...
                                  <div className="label-box rex-cf">
                                    ...
                                    <div className="label-forms rex-fl">
                                      <Input.TextArea
                                        ...
                                        value={
                                          state.formQueryDatas.disease_history
                                        }
                                        onChange={(v) =>
                                          this.handleForm(
                                            'disease_history',
                                  ...
                                  <div className="label-box rex-cf">
                                    ...
                                    <div className="label-forms rex-fl">
                                      <Input.TextArea
                                        ...
                                        value={
                                          state.formQueryDatas.disease_past
                                        }
                                        onChange={(v) =>
                                          this.handleForm(
                                            'disease_past',
                                  ...
                                  <div className="label-box rex-cf">
                                    ...
                                    <div className="label-forms rex-fl">
                                      <Input.TextArea
                                        ...
                                        value={
                                          state.formQueryDatas.disease_family
                                        }
                                        onChange={(v) =>
                                          this.handleForm(
                                            'disease_family',
                                  ...
                                  <div className="label-box rex-cf">
                                    ...
                                    <div className="label-forms rex-fl">
                                      <Input.TextArea
                                        ...
                                        value={
                                          state.formQueryDatas.inspection_result
                                        }
                                        onChange={(v) =>
                                          this.handleForm(
                                            'inspection_result',
                                  ...
                                  <div className="label-box rex-cf align-center">
                                    ...
                                    <div className="label-forms rex-fl">
                                      <Select
                                        ...
                                        value={
                                          state.formQueryDatas.diagnosis_id
                                        }
                                        onChange={(v) =>
                                          this.handleForm('diagnosis_id', v)
                                        }
                                  ...
                                  <div className="label-box rex-cf align-center">
                                    ...
                                    <div className="label-forms rex-fl">
                                      <Select
                                        ...
                                        value={
                                          state.formQueryDatas.treatment_id
                                        }
                                        onChange={(v) =>
                                          this.handleForm('treatment_id', v)
                                        }
                                      ...
                                      <div className="label-box rex-cf">
                                        ...
                                        <div className="label-forms rex-fl">
                                          <Input.TextArea
                                            ...
                                            value={
                                              state.formQueryDatas.drug_reaction
                                            }
                                            onChange={(v) =>
                                              this.handleForm(
                                                'drug_reaction',
                        ...
                        <div className="rex-fl">
                          ...
                          <div className="cy rex-cf">
                            ...
                            <Select
                              ...
                              onChange={(v) => {
                                ...
                                if (v) {
                                  setOBJ.ll_unit_price = state.ll_list.find(
                                    (val) => val.id === v
                                  ).price;
                                }
                                this.setState(setOBJ);
                            ...
                            <InputNumber
                              ...
                              value={
                                state.ll_unit_price *
                                  1 *
                                  (state.ll_count * 1) *
                                  ((100 - state.coupon_data_id2 * 1) / 100) +
                                '元'
                              }
                              readOnly
                            />
                          ...
                          <div>
                            <Button
                              ...
                              loading={this.state.saveLL_loading}
                              onClick={() => this.saveLL()}
                            >
                              {state.status === '20' || state.status === 20
                                ? '已支付'
        ...
        >
          <div className="wxrefundqrcode" style={{ width: '100%' }}>
            <img
              src={this.state.viewUserAvatar_url}
              style={{ width: '100%' }}
              className="rex-block"
              alt=""
            />
        ...
        >
          <div>
            <div className="rex-form-ctrl rex-cf">
              ...
              <Input
                className="inputs"
                value={this.state.createUserForm.name}
                onChange={(v) => this.createUserHandler('name', v.target.value)}
                placeholder="请输入姓名"
                maxLength={16}
              />
            </div>
            <div className="rex-form-ctrl rex-cf">
              ...
              <InputNumber
                className="inputs"
                value={this.state.createUserForm.mobile}
                onChange={(v) => this.createUserHandler('mobile', v)}
                placeholder="请输入手机号"
                maxLength={11}
              />
            </div>
            <div className="rex-form-ctrl rex-cf">
              ...
              <Input
                className="inputs"
                value={this.state.createUserForm.id_num}
                onChange={(v) =>
                  this.createUserHandler('id_num', v.target.value)
                }
                placeholder="请输入身份证号"
                maxLength={18}
              />
